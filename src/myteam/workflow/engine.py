...
def run_workflow(
    ...
    for step_name, step_definition in workflow.items():
        ...
        step_result = run_agent(
            ...
            interactive=resolved_step_definition.get("interactive", True),
            resume_session_id=resolved_step_definition.get("resume_session_id"),
            fork_session_id=resolved_step_definition.get("fork_session_id"),
